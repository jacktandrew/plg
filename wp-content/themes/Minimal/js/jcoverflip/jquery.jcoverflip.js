...
$.ui.jcoverflip.defaults = {
	...
	beforeCss: function( el, container, offset ){
		return [
			$.jcoverflip.animationElement( el, { left: ( container.width( )/2 - 200 - 110*offset )+'px', bottom: '20px', padding: 0, opacity: 0.5 }, { } ),
// jack
	...
	afterCss: function( el, container, offset ){
		return [
			$.jcoverflip.animationElement( el, { left: ( container.width( )/2 + 246 + 110*offset )+'px', bottom: '20px', padding: 0, opacity: 0.5 }, { } ),
// jack
			$.jcoverflip.animationElement( el.find( 'img' ), { width: '100px' }, {} )
	...
	currentCss: function( el, container ){
		return [
			$.jcoverflip.animationElement( el, { left: ( container.width( )/2 - 100 )+'px', bottom: 0, 'padding-left': '21px', 'padding-right': '21px', opacity: 1, 'z-index':10 }, { } ),
			$.jcoverflip.animationElement( el.find( 'img' ), { width: '305px' }, { } )
		];
	},
